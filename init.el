...
values."
  (setq-default
   ...
   ;; not listed in variable `dotspacemacs-configuspacemacs normal colorsration-layers'), `all' will
   ...
   dotspacemacs-additional-packages '(fiplr
                                      auto-complete
                                      irony
                                      company-irony
                                      yasnippet
...
you should place your code here."
  ...
  (setq hs-minor-mode-map
        (let ((map (make-sparse-keymap)))
          ...
          (define-key map (kbd "C-c -") 'evil-close-fold)
          (define-key map (kbd "C-c =") 'evil-open-fold)
          (define-key map (kbd "C-c _") 'evil-close-folds)
          (define-key map (kbd "C-c +") 'evil-open-folds)
          (define-key map (kbd "C-c l") 'evil-fold-level)
